...
/**
 * An ordered collection of comparable items.
 * Implements the AscendinglyOrderedListInterface
 *
 * @author Scott Eno
 */
public class AscendinglyOrderedListD<T extends KeyedItem<KT>, KT extends Comparable <? super KT>>
    implements AscendinglyOrderedListInterface<T, KT>
{
     ...
     */
    public AscendinglyOrderedListD()
    {
...
//        int compare = (numItems != 0) ? key.compareTo(items[lower].getKey()) : -1;
        int compareVal = key.compareTo(items[lower].getKey());
